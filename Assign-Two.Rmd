...
```
Figure 2: Funnel Plot of The Transformed Log Ratio of Means against the Inverse Standard Error, with a ylim of 100 to exclude outliers
...
```
Table 5: Meta-Regression Model with Inverse Sampling Variance Testing for File-Drawer Bias
...
```
Based on the meta-regression results, it seems that there is evidence for publicatin bias, specifically, time-lag bias ? 
